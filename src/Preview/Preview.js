...
export const Preview = ({title, newItem1, newItem2, newItem3, newItem4, newItem5}) => {
    return (
        <section>
            <h2>Preview</h2>
            <svg className={styles.menu} viewBox={`0, 0, ${width}, ${height}`}>
                ...
                <text textAnchor="middle" x={midpoint} y={200} className={styles.title}>{title}</text>
                
                <g transform={`translate(${barMenuStart}, 500)`}>
                    <text textAnchor={"middle"} x={menuWidth/2} y={0} className={styles.subtitle}>Bar Menu</text>
                    <MenuItem y={150} name={newItem1} price={5} description={"Tomato Sauce, Garlic"}/>
                    <MenuItem y={350} name={newItem2} price={8} description={"Tomato Sauce and mozzarella"}/>
                    <MenuItem y={550} name={newItem3} price={10} description={"Goat's cheese, asparagus and parmesan"}/>
                    <MenuItem y={750} name={newItem4} price={9} description={"Ham and pineapple"}/>
                    <MenuItem y={950} name={newItem5} price={11} description={"Roasted Peppers, onion and pancetta"}/>
                </g>
